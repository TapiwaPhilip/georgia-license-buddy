      ...
      <div className="container px-4 sm:px-6 py-12 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-muted-foreground text-sm">
              Helping Europeans get Georgian driving licenses quickly and hassle-free.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/refund" className="text-muted-foreground hover:text-primary text-sm">
                  Refund Policy
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © {currentYear} GeoLicense. All rights reserved.
          </p>
